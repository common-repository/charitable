<?php
/**
 * Charitable Donation Activities DB class.
 *
 * @package     Charitable/Classes/Charitable_Donation_Activities_DB
 * @version     1.8.1
 * @author      David Bisset
...
if ( ! class_exists( 'Charitable_Donation_Activities_DB' ) ) :
	...
	/**
	 * Charitable_Donation_Activities_DB
	 *
	 * @since   1.8.1
	 */
	class Charitable_Donation_Activities_DB extends Charitable_DB {

		/**
		 * The single instance of this class.
		 *
		 * @var Charitable_Donation_Activities_DB|null
		 */
		 ...
		 * @var     string
		 */
		public $table_name = 'charitable_donation_activities';
		 ...
		 * @since  1.8.1
		 *
		 * @return Charitable_Donation_Activities_DB
		 */
